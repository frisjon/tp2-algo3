...
public class Juego {
	...
	public void agregarEquipos() {
		...
		//System.out.println(jugador1.getNombre() + " elegi tu equipo (1 o 2): ");
		//Scanner input = new Scanner(System.in);
		...
		String numero_equipo = "1"; // para que pase, si no me tiraba siempre "Eleccion incorrecta"
	...
	public void jugar(){
		this.agregarJugador("1");
		this.agregarJugador("2");
		this.agregarEquipos();
		this.distribuirPersonajesEquipos();
