...
public class BotonArribaIzquierdaEventHandler extends BotonHandler {

    private ContenedorJuego contenedorJuego;
    private Tablero tablero;
    private RepresentacionPersonaje personaje;

    public BotonArribaIzquierdaEventHandler(ContenedorJuego _contenedorJuego, Tablero _tablero, RepresentacionPersonaje _personaje) {
    ...
    public void handle(ActionEvent event) {
        ...
        this.contenedorJuego.mostrarConsola(this.personaje.getPersonaje().getNombre()+" se mueve arriba");
    }
