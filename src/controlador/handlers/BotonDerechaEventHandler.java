...
public class BotonDerechaEventHandler extends BotonHandler {

    private ContenedorJuego contenedorJuego;
    private Tablero tablero;
    private RepresentacionPersonaje personaje;

    public BotonDerechaEventHandler(ContenedorJuego _contenedorJuego, Tablero _tablero, RepresentacionPersonaje _personaje) {
    ...
    public void handle(ActionEvent event) {
        ...
        this.contenedorJuego.mostrarConsola(this.personaje.getPersonaje().getNombre()+" se mueve a la derecha");
    }
