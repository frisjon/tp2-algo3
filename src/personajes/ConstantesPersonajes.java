...
public final class ConstantesPersonajes {
    ...
    public static final double GOKU_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1.2;
    ...
    public static final double GOHAN_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1;
    ...
    public static final double PICCOLO_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1;
    ...
    public static final double CELL_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1;
    ...
    public static final double FREEZER_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1;
    ...
    public static final double MAJINBOO_PORCENTAJE_AUMENTO_ATAQUE_PASIVA = 1;
